    ...
    <div class="container">
      ...
      <template v-if="favoriteProduct.length!==0">
          ...
          <div class="col table-responsive mt-4 mb-4">
            <table class="table align-middle text-center table-light table-borderless">
              ...
              <tr class="table-nowrap" v-for="item in favoriteProduct" :key="item.id">
                <td class="d-block favorite-table">
        ...
        <div class="text-end mt-4 mb-5">
          <RouterLink class="btn btn-primary ms-auto text-end hover-btn" to="/cart">Go To Cart<i class="bi bi-cart-fill ps-1"></i></RouterLink>
        </div>
      </template>
      <template v-else>
        <div class="py-5 mb-5">
          <div class="text-center pt-4">
            ...
            <RouterLink class="btn btn-primary btn-lg fw-bold" to="/products">See More Products !</RouterLink>
          </div>
        </div>
      </template>
    </div>
